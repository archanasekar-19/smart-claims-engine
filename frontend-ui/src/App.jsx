...
const PDF_SAMPLES = [
  {
    name: 'Fast Track',
    file: 'FNOL_FastTrack_ArjunMehta.pdf',
    mockKey: 'Fast Track',
  },
  {
    name: 'Investigation Flag',
    file: 'FNOL_InvestigationFlag_MichaelDSouza.pdf',
    mockKey: 'Investigation Flag',
  },
  {
    name: 'Specialist Queue',
    file: 'FNOL_SpecialistQueue_RajeshKumar.pdf',
    mockKey: 'Specialist Queue',
  },
  {
    name: 'Manual Review',
    file: 'FNOL_ManualReview_PriyaNair.pdf',
...
const MOCK_DATA = {
  'Fast Track': {
    extractedFields: {
      ...
      description:
        'The insured vehicle was stationary at a red light when a two-wheeler rider lost control and scraped the left rear bumper. No injuries reported.',
    ...
    reasoning:
      'Estimated damage is below ₹25,000. Minor collision with no injuries, all mandatory fields present, and documentation complete.',
    missingFields: [],
    inconsistencies: [],
  },
  ...
  'Investigation Flag': {
    extractedFields: {
      policy_number: 'POL-KA-2025-00778',
      policyholder_name: "Michael D'Souza",
      incident_date: '14 May 2026',
      incident_time: '11:00 PM',
      location: 'Outer Ring Road, Bangalore, Karnataka',
      description:
        "Witness statement is inconsistent with vehicle damage pattern. Claim appears staged according to field assessor. Possible fraud indicators noted.",
      claimant: "Michael D'Souza",
    ...
    reasoning:
      'Suspicious keywords detected in claim description (staged, inconsistent, fraud indicators). Multiple mandatory fields missing.',
    missingFields: ['effective_dates', 'contact_details', 'asset_type', 'asset_id', 'initial_estimate'],
    inconsistencies: ['Claim description contains fraud/staging indicators noted by field assessor'],
  },

  'Specialist Queue': {
    extractedFields: {
      policy_number: 'POL-MH-2025-00334',
      policyholder_name: 'Rajesh Kumar',
      effective_dates: '01 January 2025 – 31 December 2025',
      incident_date: '11 May 2026',
      incident_time: '3:00 PM',
      location: 'Mumbai-Pune Expressway, km 54.2, Maharashtra',
      description:
        'High-speed collision involving two other vehicles. Multiple passengers sustained injuries. Two admitted with spinal trauma. Driver fractured right wrist.',
      ...
      attachments: 'FIR Copy, Medical Admission Reports, RC Book, 12 Photographs, Spot Survey Report',
      initial_estimate: 115000,
    },
    recommendedRoute: 'Specialist Queue',
    reasoning:
      'Claim type is Personal Injury with multiple passengers injured and third-party involvement. Specialist handling and MACT proceedings anticipated.',
    missingFields: [],
    inconsistencies: [],
  },
  ...
  'Manual Review': {
    extractedFields: {
      policy_number: 'POL-KL-2025-00556',
      policyholder_name: 'Priya Nair',
      incident_date: '09 May 2026',
      incident_time: '6:45 PM',
      location: 'Edapally Junction, Kochi, Kerala',
      description:
        'Side-swipe collision at a busy junction. Extent of damage unclear from blurry photographs. Workshop assessment conflicts with claimant description.',
      claimant: 'Priya Nair',
      contact_details: '9988776655',
      asset_id: 'KL07EF9012',
      estimated_damage: 95000,
      claim_type: 'Vehicle Damage',
      attachments: 'Blurry Photos (3 images, low resolution)',
    },
    recommendedRoute: 'Manual Review',
    reasoning:
      'Mandatory fields (effective dates, asset type, initial estimate) are missing. Conflicting statements and inconclusive photo evidence require human adjuster review.',
    missingFields: ['effective_dates', 'asset_type', 'initial_estimate'],
    inconsistencies: [],
  },
}
...
export default function App() {
  ...
  const processFile = async (selectedFile, mockKey) => {
    ...
    try {
      ...
      // Fallback to mock data keyed by the sample name
      data = MOCK_DATA[mockKey] || MOCK_DATA['Fast Track']
    }
    ...
    <div style={{
      ...
      <div style={{ maxWidth: 1440, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 24 }}>
        ...
        <div style={{
          ...
          <div style={{ position: 'absolute', right: -100, top: -100, width: 260, height: 260, borderRadius: '50%', background: 'rgba(255,255,255,0.08)' }} />
          <div style={{ position: 'absolute', left: -70, bottom: -70, width: 180, height: 180, borderRadius: '50%', background: 'rgba(255,255,255,0.05)' }} />
          <div style={{ position: 'relative', zIndex: 1 }}>
            <h1 style={{ margin: 0, fontSize: 28, fontWeight: 700, lineHeight: 1.3, color: '#ffffff' }}>
              Autonomous Insurance Claims Processing Agent
            </h1>
            <p style={{ marginTop: 18, fontSize: 20, opacity: 0.92, lineHeight: 1.7, maxWidth: 760 }}>
        ...
        <div style={card}>
          ...
          <div style={{ marginTop: 20 }}>
            <p style={{ margin: '0 0 12px', fontSize: 13, fontWeight: 600, color: '#64748b', textAlign: 'center', letterSpacing: '0.04em', textTransform: 'uppercase' }}>
              Try a sample FNOL PDF
            </p>
            <div
              style={{
                display: 'flex',
